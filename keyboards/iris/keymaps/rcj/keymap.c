...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
     SCD ,ZNP , X  , C  , V  , B  , SPC,     LSFT, N  , M  ,COMM,DOT ,BRSL,HYPR,
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
                       MOV ,LCTL, SPC ,       LSFT ,LALT,LGUI
  //                  `----+----+----'        `----+----+----'
  ),
  // SAE = Super+LALT/Enter | SCD = Super+LCTL/DEL | NP = Numpad
  ...
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,    ,PGUP, UP ,PGDN,HOME,                   ,PGDN,PGUP,LPRN,RPRN,F12 ,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
         ,    ,LEFT,DOWN,RGHT,END ,               LEFT,DOWN, UP ,RGHT,    ,    ,
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
         ,    ,INS ,    ,    ,PSCR,    ,         ,    ,HOME,END ,    ,    ,    ,
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
                           ,    ,    ,             ,    ,
